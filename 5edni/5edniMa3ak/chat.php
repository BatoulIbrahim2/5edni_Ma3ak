...
echo "</table";
$query = "INSERT INTO chat (user1,user2, message) VALUES ('$id','$d_id', '$message')";
...
$query2 = "SELECT *  FROM chat where (user1='$d_id' and user2='$id') or ( user1='$id' and user2='$d_id')  ";
    ...
    <body>
        ...
        <div id="wrapper">
            <div id="menu">
                ...
                <p class="logout"><a id="exit" href="mainpage.php">Exit Chat</a></p>
            </div>
            <div id="chatbox"></div>
