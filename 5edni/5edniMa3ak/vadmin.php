...
<div class="topnav" id="t">
   <a href="radmin.php">THE RIDES</a>
    ...
    <br>
_b;
$query = "SELECT * FROM reservations where date >= '$currentDate'  ";
...
if($r==0){
   echo"<h1>NO RESULT!</h1>"; 
    ...
    echo<<<_END
<table>
<tr><th>id</th><th>Passenger Id</th><th>Driver Id</th><th>Location</th><th>destination</th><th>date</th><th>Start Time</th><th>Return Time</th><th>delete</th></tr>


_END;
for ($i = 0; $i < $r; $i++) {
    $row = mysqli_fetch_assoc($result);
    echo"<tr><td><br>" .$row['id']."<br></td><td><br>". $row['p_id'] . "<br></td><td><br>" . $row['d_id'] . "<br></td><td><br>". $row['start'] . "<br></td><td><br>" . $row['end'] . "<br></td><td><br>" . $row['date'] . "<br></td><td><br>" . $row['time'] .
     "<br></td><td><br>" . $row['timereturn'] . "<br></td><td><a href ='delete4.php?id=" . $row['id'] . "'><img src='delete.png' "
