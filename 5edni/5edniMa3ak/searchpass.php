...
$query2 = "SELECT id,FullName,phoneNumber,email FROM passenger where id='$user'";
...
if($r2==0){
    ...
    echo<<<_END
<br></br><table>
<tr><th>id</th><th>Name</th><th>Phone Number</th><th>email</tr>
...
for ($i = 0; $i < $r2; $i++) {
    ...
    echo"<tr><td>" .$row2['id']."</td><td>". $row2['FullName'] .  "</td><td>" . $row2['phoneNumber'] . "</td><td>" . $row2['email'] . "</td>"
    . "</tr>";
}
echo "</table";
}
...
<body>
    <form method="POST" action="searchpass.php">
  <div class="container">
    <h1>User Search</h1>
    <form>
