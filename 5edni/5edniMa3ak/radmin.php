...
<a href="radmin.php">THE RIDES</a>
    ...
    <a href="searchride.php"> <div class="logo">
...
b;
$id = $_SESSION['id'];
$query = "SELECT id,driver_id,start_location, end_location, departure_time,time,timereturn,available_seat,smoking,food,drink,music,ac,gender FROM ride where departure_time >= '$currentDate' ";
...
if($r==0){
    ...
    echo<<<_END
<br></br><table>
<tr><th>id</th><th>id</th><th>Start Location</th><th>End Location</th><th>Date</th><th>Time of Start</th><th>Time of Return</th><th>Available Seat</th><th>additional-details:</th><th>delete</th></tr>
...
for ($i = 0; $i < $r; $i++) {
    ...
    "</td><td>" . $row['time'] . "</td><td>" . $row['timereturn'] . "</td><td>" . $row['available_seat'] . "</td><td>" . $row['smoking'] . "<br>" . $row['food'] . "<br>" . $row['drink'] . "<br>" . $row['music'] . "<br>" . $row['ac'] . "<br>" . $row['gender'] . "<br>" . "<td><a href ='delete3.php?id=" . $row['id'] . "'><img src='delete.png' "
