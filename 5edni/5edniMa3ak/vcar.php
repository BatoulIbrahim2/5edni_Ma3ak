...
echo<<<_END
   ...
   _END;
$query = "SELECT CarNumber, color,type  FROM car where id ='$id' ";
$result = mysqli_query($con, $query);
$r = mysqli_num_rows($result);
if($r==0){
    echo"<br><h1>NO RESULT!</h1><br><h1>YOU DO NOT Have ANY CAR!</h1><br><h1>PLIZ ADD A NEW CAR</h1>";
}else{
    echo<<<_END
      </div><br><br>
<br></br><table>
<tr><th>Car Number</th><th>Color</th><th>type</th><th>ID of Car</th><th>Delete</th></tr>
...
$r2 = mysqli_num_rows($result2);
   $row2 = mysqli_fetch_assoc($result2);
    echo"<tr><td>" .$row['CarNumber']."</td><td>". $row['color'] .  "</td><td>" . $row['type'] . "</td><td class='img-td'><img src='uploads/".$row2['image_url']."'/></td><td><a href ='deletecar.php?CarNumber=" . $row['CarNumber'] . "'><img src='delete.png' "
...
.tx img{
  ...
  <link rel="stylesheet" type="text/css" href="style.css">
    ...
    <body>
     ...
     <form method="POST" action="vcar.php">
        <div class="bottom-link">
           
            <a href="car.php"> Add New Car </a>
        </div></form>
    </body>
</html>
