...
<div class="topnav" id="t">
   <a href="radmin.php">THE RIDES</a>
    ...
    <a href="searchpaid.php"> <div class="logo">
        ...
        <br>
_B;
$query2 = "SELECT id,user_id,name,phone,email,month,value,paid FROM payment ";
...
.search {
  order: 2; /* Place the search second */
}
h1 {
...
h1 {
  ...
  font-family: Brush Script MT,cursive;
    ...
    <div class="search">
      <!-- Your search input field or form here -->
    </div>
  </header>
