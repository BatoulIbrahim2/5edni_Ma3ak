...
<a href="radmin.php">THE RIDES</a>
    ...
    <a href="searchpass.php"> <div class="logo">
...
$query = "SELECT id,FullName,PhoneNumber,email,password FROM passenger  ";
...
if($r==0){
    ...
    echo<<<_END
<br></br><table>
<tr><th>id</th><th>FullName</th><th>Phone Number</th><th>Email</th><th>Delete</th></tr>


_END;
for ($i = 0; $i < $r; $i++) {
    $row = mysqli_fetch_assoc($result);
    echo"<tr><td>" .$row['id']."</td><td>". $row['FullName'] . "</td><td>" . $row['PhoneNumber'] . "</td><td>" . $row['email'] . "</td><td><a href ='delete2.php?id=" . $row['id'] . "'><img src='delete.png' "
