...
_END;
$query = "SELECT id,user1,user2  FROM chat where user2='$a'  ";
...
echo<<<B
    <table>
<tr><th>Id of Passenger</th><th>View Message</th><th>Delete</th></tr>
B;
for ($i = 0; $i < $r; $i++) {
    $row = mysqli_fetch_assoc($result);
   
    echo"<tr><td>" . $row['user1'] . "<td><a href ='chatadmin2.php?user1=". $row['user1'] . "'><img src='messagead.png'height='20px' width='20px'></a></td><td><img class='order-img'  /> <a href ='delete3.php?id=" . $row['id'] . "'><img src='delete.png' "
...
td:last-child {
  color: #ff8c00;
    ...
    <body>
           <form method="GET" action="message.php" enctype='multipart/form-data'> <br>
   </body>
    </head>
</html>
